...
/**
 * Cached list of selectors for a domain.  Cache entirely
 * cleared if any element is added or removed.
 * @type Object
 */
let selectorCacheByDomain = {__proto__: null};
...
let ElemHide = exports.ElemHide =
{
  ...
  clear: function()
  {
    selectorCacheByDomain = {__proto__: null};
  ...
  {
    // If we have seen this request before, return it from the cache
    let cacheKey = domain + specificOnly;
    if (cacheKey in selectorCacheByDomain) 
      return selectorCacheByDomain[cacheKey];
    ...
    return selectorCacheByDomain[cacheKey] = result;
  }
};
