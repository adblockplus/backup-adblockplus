...
let SyncServiceObserver =
{
  ...
  initEngine: function()
  {
    ...
    ABPEngine = function() {};
    ABPEngine.prototype = Object.create(SyncEngine.prototype);
    ABPStore = function() {};
    ABPStore.prototype = Object.create(Store.prototype);
    ABPTracker = function() {};
    ABPTracker.prototype = Object.create(Tracker.prototype);
